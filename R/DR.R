...
#' it integrates a log10Normal Poisson distribution \insertCite{Pouillot2015;textual}{DRLm}. 
...
#' @references
#' 
#' \insertRef{EFSA2018}{DRLm}
#' 
#' \insertRef{FAO-WHO2004}{DRLm}
#' 
#' \insertRef{Fritsch2018}{DRLm}
#' 
#' \insertRef{Pouillot2015}{DRLm}
#'
#'
#' @export
#'
